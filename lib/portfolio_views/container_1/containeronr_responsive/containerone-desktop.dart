...
class _ContainerOneDesktopState extends State<ContainerOneDesktop>
  ...
  final String phoneNumber = '+923185094710'; // WhatsApp number
  final String email = 'mailto:attambar2@gmail.com'; // Email link
  final String github = 'https://github.com/username'; // GitHub profile
  final String linkedin = 'https://linkedin.com/in/username'; // LinkedIn profile
  ...
  void initState() {
    ...
    _textSlideAnimation = Tween<Offset>(begin:const Offset(-1, 0), end:const Offset(0, 0))
          ...
          Row(
            ...
            children: [
              Container(
                width: width * 0.7,
                child: Padding(
                  padding:const EdgeInsets.only(top: 40, left: 190, right: 50),
                      ...
                      const  SizedBox(height: 20),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            _buildHoverIcon(Icons.message, 'https://wa.me/$phoneNumber'),
                          ],
                        ),
                      ],
                    ),
